...
make_local_id(SourceThing, TargetThing, Filter) ->
    S = couch_util:encodeBase64Url(couch_hash:hash(term_to_binary(SourceThing))),
    T = couch_util:encodeBase64Url(couch_hash:hash(term_to_binary(TargetThing))),
...
find_repl_doc(SrcDb, TgtUUIDPrefix) ->
    ...
    S = couch_util:encodeBase64Url(couch_hash:hash(term_to_binary(SrcUUID))),
